...
const Center: NextPage = () => {
    ...
    const copyText = () => {
        navigator.clipboard.writeText(BaseComponent(text.input));
        (document.getElementById("copyButton") as HTMLElement).innerHTML = "copied!";
        setTimeout(() => {
            (document.getElementById("copyButton") as HTMLElement).innerHTML = "copy";
        }, 2000);
    }
