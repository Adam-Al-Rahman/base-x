        ...
        <div className="flex flex-col w-full lg:flex-row min-h-screen">
          ...
          <div className="m-5 p-8 sm:m-5 sm:p-20 lg:grid flex-grow card bg-base-200 rounded-box place-content-start">
            <div className="h-content-container">
              ...
              <h2 className="mt-8 mb-8 text-xl sm:text-3xl sm:mb-8 font-bold font-mono">Base Converter</h2>
              <Center />
            </div>
            <footer className="footer lg:hidden sticky top-[100vh] items-center p-4 bg-neutral text-neutral-content rounded-box">
              <div className="items-center grid-flow-col">
                ...
                <p> <p className="text-center font-bold">Design & Built by <Link href="https://atiq-ur-rehaman.netlify.app/" className="hover:text-blue-500">Adam Al-Rahman</Link></p>Copyright © {new Date().getFullYear()} </p>
              </div>
