      ...
      <div data-theme="night" >
        ...
        <div className="flex flex-col w-full lg:flex-row min-h-screen">
          <div className="hidden lg:grid m-5 p-5 max-w-sm flex-grow card bg-base-200 rounded-box">
            ...
            <div className="m-2 text-center bg-primary rounded-box">
