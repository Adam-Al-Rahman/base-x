          ...
          <div className="hidden lg:grid m-5 p-5 max-w-sm flex-grow card bg-base-200 rounded-box">
            ...
            <div className="mockup-code m-2 ">
              ...
              <div className="flex flex-col -mb-6">
                ...
                <Link href="https://atiq-ur-rehaman.netlify.app/"><button className="btn btn-outline btn-primary w-32 m-4">Read More</button></Link>
              </div>
            </div>
